...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x15(/* Base */
			...
			KC_QUOT, KC_J, KC_B, KC_U, KC_F, KC_W, KC_LCBR, KC_PSCR, KC_RCBR, KC_G, KC_M, KC_P, KC_N, KC_Q, KC_MINS,
			KC_TAB, KC_H, KC_R, KC_E, KC_A, KC_L, KC_LPRN, MO(1), KC_RPRN, KC_C, KC_T, KC_I, KC_S, KC_D, KC_ENT,
			KC_CAPS, KC_SCLN, KC_Z, KC_Y, KC_O, KC_X, KC_SLSH, KC_LGUI, KC_BSLS, KC_K, KC_V, KC_COMM, KC_DOT, KC_UP, KC_INS,
