...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x15(/* Base */
			KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_LBRC, KC_BSLS, KC_RBRC, KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL,
			KC_TAB, KC_K, KC_N, KC_P, KC_M, KC_W, KC_SLSH, KC_GRV, KC_SCLN, KC_G, KC_R, KC_BSPC, KC_COMM, KC_DOT, KC_MINS,
			KC_ENT, KC_D, KC_S, KC_SPC, KC_T, KC_C, KC_APP, KC_LGUI, KC_WAKE, KC_U, KC_O, KC_E, KC_L, KC_H, KC_QUOT,
			KC_PGUP, KC_Z, KC_Q, KC_I, KC_B, KC_V, MO(1), KC_RALT, MO(1), KC_A, KC_Y, KC_F, KC_X, KC_J, KC_HOME,
