...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x15(/* Base */
			KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_LBRC, KC_GRV, KC_RBRC, KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL,
			KC_TAB, KC_J, KC_N, KC_U, KC_F, KC_G, KC_LCBR, KC_APP, KC_RCBR, KC_P, KC_W, KC_M, KC_O, KC_Q, KC_BSLS,
			KC_CAPS, KC_H, KC_S, KC_E, KC_A, KC_L, KC_LPRN, MO(1), KC_RPRN, KC_C, KC_T, KC_I, KC_R, KC_D, KC_QUOT,
			KC_HOME, KC_PGUP, KC_X, KC_Y, KC_COMM, KC_DOT, KC_SCLN, KC_LGUI, KC_MINS, KC_V, KC_B, KC_K, KC_Z, KC_UP, KC_SLSH,
			KC_END, KC_PGDN, KC_PSCR, KC_INS, KC_DEL, ON, OSM(MOD_LSFT), KC_RCTL, KC_RALT, KC_SPC, KC_BSPC, KC_ENT, KC_LEFT, KC_DOWN, KC_RGHT
		),
