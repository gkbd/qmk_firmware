...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x15(/* Base */
			...
			KC_QUOT, KC_J, KC_O, KC_U, KC_F, KC_W, KC_LCBR, KC_PSCR, KC_RCBR, KC_G, KC_M, KC_P, KC_N, KC_Q, KC_MINS,
			KC_TAB, KC_H, KC_S, KC_E, KC_A, KC_L, KC_LPRN, MO(1), KC_RPRN, KC_C, KC_T, KC_I, KC_R, KC_D, KC_ENT,
			KC_CAPS, KC_SCLN, KC_X, KC_Y, KC_COMM, KC_DOT, KC_SLSH, KC_LGUI, KC_BSLS, KC_K, KC_V, KC_B, KC_Z, KC_UP, KC_INS,
			KC_ESC, KC_HOME, KC_END, KC_DEL, KC_BSPC, ON, OSM(MOD_LSFT), KC_RCTL, KC_RALT, KC_SPC, KC_PGDN, KC_PGUP, KC_LEFT, KC_DOWN, KC_RGHT
		),
